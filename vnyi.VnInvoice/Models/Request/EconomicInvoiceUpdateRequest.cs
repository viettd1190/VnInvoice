...
{
    public class EconomicInvoiceUpdateRequest : EconomicInvoiceCreateRequest
    {
        public EconomicInvoiceUpdateRequest()
        {
        }

        public EconomicInvoiceUpdateRequest(EconomicInvoiceUpdateModel model) : base(model)
        {
