...
{
    public class InternalDeliveryUpdateRequest : InternalDeliveryCreateRequest
    {
        public InternalDeliveryUpdateRequest()
        {
        }

        public InternalDeliveryUpdateRequest(InternalDeliveryUpdateModel model) : base(model)
        {
